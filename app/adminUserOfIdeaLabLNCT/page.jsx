...
import verTok from "../controllers/verTok";
...
const page = () => {
    ...
    // verTok?null:window.location.href = '/login'  
  ...
  return (
    <>
        <div className="bg-black max-sm:w-[100vw] max-sm:h-210">
            <h1 className="text-[2.4rem] xl:w-[40rem] font-bold text-white leading-[4rem] pt-16 ms-40 max-sm:text-3xl max-sm:leading-[3.5rem] max-sm:pt-6 max-sm:text-center max-sm:ms-0 ">Admin Settings </h1>       
            <hr className="mx-auto w-[80%] h-[1.5px] bg-[#373647] border-0 rounded mt-6 max-sm:w-[100vw]  "/>
            <div className="grid grid-rows-4 grid-flow-col gap-8 justify-items-center mt-14 max-sm:gap-16 ">
                <div className="w-[80%] flex gap-7 justify-center items-center max-sm:w-full max-sm:gap-3 max-sm:flex-col ">
                    <div className="w-20 bg-[#1f2127] p-2 rounded-xl">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <button type="submit" className="w-36 h-10 bg-[#292C36] rounded-md xl:ms-auto hover:bg-[#393b41]"><Link href={'/adminUserOfIdeaLabLNCT/addEvents'}>Go to Page</Link></button>
                </div>
                <div className="w-[80%] flex gap-7 justify-center items-center max-sm:w-full max-sm:gap-3 max-sm:flex-col ">
