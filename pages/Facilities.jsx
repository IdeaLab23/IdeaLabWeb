  ...
  return (
    <div id="facilities" className="bg-black pt-14 max-sm:w-fill  ">
      ...
      <div className="flex max-sm:flex max-sm:flex-col max-sm:items-center max-sm:text-center max-sm:w-[22rem] ">
        <h1 className="text-[3rem] font-bold font-mono text-white leading-[4rem] ms-56 max-sm:text-[2rem] max-sm:leading-[6rem] max-sm:my-10 max-sm:ms-0 ">Our World Class Facilities<br/>and Resources</h1>
