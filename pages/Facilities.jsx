...
const data=
  [
    ...
    "A CNC (Computer Numerical Control) router is a versatile machine tool used for cutting, carving, and shaping materials like wood, plastic, metal, and composite materials",
    "A portable drilling machine is a tool used to drill holes in various types of materials, such as wood, metal, and plastic. ",
    "A Mixed Signal Oscilloscope (MSO) is a versatile testing tool that combines the functionality of both an analog oscilloscope and a digital oscilloscope.",
  ...
  return (
    <div id="facilities" className="bg-black pt-14 max-sm:w-full max-sm:pt-16 ">
      ...
      <div className="flex justify-center gap-7 my-14 max-sm:flex max-sm:flex-col max-sm:items-center max-sm:ms-2 ">
        <Facilities_comp title="3d Printer"  description={data[0]} img_path="/auto.png" hover_img_path="/3dprinter_real.jpg"/>
        <Facilities_comp title="CNC  Router" description={data[1]} img_path="/pre.png" hover_img_path="/cnc_router_real.jpg"/>
        <Facilities_comp title="3D Scanner" description={data[2]} img_path="/manu.png" hover_img_path="/3dscanner_real.jpg"/>
      </div>
      <div className="flex justify-center gap-7 max-sm:flex max-sm:flex-col max-sm:items-center max-sm:ms-2 ">
        <Facilities_comp title="Mixed Signal Oscilloscope" description={data[3]} img_path="/safety.png" hover_img_path="/mixed_singal_real.jpg"/>
        <Facilities_comp title="Laser Cutter" description={data[4]} img_path="/drill.png" hover_img_path="/lasercutter_real.jpg"/>
        <Facilities_comp title="PCB Prototype Machine" description={data[5]} img_path="/pre.png" hover_img_path="/pcb_real.jpg" />
