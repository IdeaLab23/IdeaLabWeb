...
const Page3 = () => {
  ...
  return (
    <div className="pt-24 pb-10 bg-black w-full  ">
        ...
        <div className="xl:flex justify-center gap-6 mt-28 mb-32 max-sm:flex max-sm:flex-col max-sm:gap-5 max-sm:20  max-sm:w-[6rem] ">
            <OfferComp2 title="64K+" text="Success Projects" />
            <div className="w-[275px] h-[266px] flex flex-col justify-center bg-[#7B8CE5] hover:bg-[#151721] max-sm:w-fill max-sm:h-[25rem] ">
                <p className="text-6xl font-mono font-bold text-white text-center max-sm:text-4xl ">54+</p>
                <p className="text-slate-200 text-xl text-center mt-4 max-sm:text-4xl max-sm:mt-7 ">Expert Team</p>
            </div>
    ...
    <div className="flex justify-evenly max-sm:flex max-sm:flex-col max-sm:ms-8 max-sm:w-[8rem] ">
        ...
        <Image className="max-sm:w-[105rem] max-sm:h-[170rem] max-sm:ms-5 max-sm:my-10"
          src="/man_inside.jpg"
          alt="Can't Load"
          width="640px"
          height="500px"
