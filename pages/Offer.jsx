...
const Page3 = () => {
  ...
  return (
    <div className="pt-24 pb-10 bg-black w-full  ">
        ...
        <div className="w-[45rem] ms-56 max-sm:w-[55rem] max-:text-center max-sm:ms-3 ">
        ...
        <div className="flex justify-center gap-6 mt-28 mb-32 max-sm:flex max-sm:flex-col max-sm:gap-10 max-sm:items-center max-sm:w-[6rem] ">
            <OfferComp2 title="64K+" text="Success Projects" />
            <div className="w-[275px] h-[266px] flex flex-col justify-center bg-[#7B8CE5] hover:bg-[#151721] max-sm:w-fill max-sm:h-[50rem] ">
