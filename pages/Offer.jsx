  ...
  return (
    <div className="pt-24 pb-10 bg-black w-full ">
        ...
        <div className="flex flex-col justify-center items-center gap-10 max-sm:px-12 xl:flex xl:flex-row xl:justify-center xl:gap-6 xl:mt-28 xl:mb-32 ">
            <OfferComp2 title="100+" text="Workshops" />
            <div className="w-[275px] h-[266px] flex flex-col justify-center bg-[#7B8CE5] hover:bg-[#151721] max-sm:w-[17rem] max-sm:h-[17rem] ">
                <p className="text-6xl font-mono font-bold text-white text-center max-sm:text-5xl ">25+</p>
                <p className="text-slate-200 text-xl text-center mt-4 max-sm:text-2xl max-sm:mt-7 ">Success Projects</p>
            </div>
            <OfferComp2 title="1K+" text="Active Learners" />
            <OfferComp2 title="100+" text="Skilling programs" />
        </div>
