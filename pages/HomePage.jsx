  ...
  return (
    ...
    <Navbar />
      <div className="flex xl:ms-56 xl:mt-20 mt-24 ms-6 ">
        <div className="text-white xl:w-[38rem] w-[50rem]  ">
        ...
        <div className="xl:mt-14 absolute xl:left-[54rem] xl:w-[490px] xl:h-[560px] w-[550px] h-[670px] mt-[125rem] left-[4px]  right-0">
          <Image
            src="/robo.png"
            alt="robo"
            layout="fill"
      ...
      <hr className="mx-auto w-[75%] mt-28 max-sm:mt-[47rem] max-sm:w-[100%] max-sm:ms-4 "/>
    </>
  )
}
