    ...
    <Navbar />
      <div className="flex xl:ms-56 xl:mt-20 mt-24 mx-9">
        <div className="text-white xl:w-[38rem]">
          ...
          <h1 className="xl:text-6xl font-bold xl:mt-4 xl:leading-[5rem] text-[4rem] mt-8 leading-[4rem] max-sm:text-center"><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFC9FD] to-[#0DD0FF]">Changing Your Ideas</span> <br /> into innovative <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0DD0FF] to-[#FFC9FD]">Projects.</span></h1>
          <p className="text-xl mt-8 mb-5 font-[Comfortaa] tracking-wide max-sm:text-3xl max-sm:leading-normal max-sm:text-center max-sm:mt-10 max-sm:mb-9">Unlock your creative potential at IDEALab. We offer a nurturing space and essential tools to fuel your innovative ideas, empowering you to turn ideas into reality.</p>
          <button className="xl:w-52 xl:h-14 bg-[#7B8CE5] rounded-full xl:text-lg font-mono hover:bg-white hover:text-[#7B8CE5] w-[15rem] h-16 ms-11 text-2xl">Discover More</button>
        </div>
